...
var HELP_OVERLAY_HTML =
  ...
  '<li><strong>Onda corta</strong> — <span class="material-symbols-outlined help-inline-icon" aria-hidden="true">settings_input_antenna</span> muestra en el mapa mundial las emisoras internacionales probablemente al aire ahora (horarios <a href="http://www.eibispace.de/" target="_blank" rel="noopener">EiBi</a>), con filtros por idioma y emisiones dirigidas a América. Oírlas depende de la propagación.</li>' +
