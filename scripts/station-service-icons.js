...
(function () {
  ...
  var ALLOWED = ['atc', 'fire', 'ambulance', 'sea', 'broadcast'];
  ...
  var PATHS_INNER = {
    ...
    broadcast:
      '<circle fill="currentColor" cx="4" cy="12" r="2.2"/>' +
      '<path fill="currentColor" d="M9 7L9 17L7 14.5L7 9.5Z"/>' +
      '<path fill="currentColor" d="M16 2L16 22L11 16L11 8Z"/>',
  };
  ...
  /**
   * @param {object} r node
   * @returns {''|'atc'|'fire'|'ambulance'|'sea'|'broadcast'}
   */
